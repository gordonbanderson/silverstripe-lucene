...
Version for Silverstripe 3
Gordon Anderson
<gordon (at) weboftalent (dot) asia>


# Requirements
* SilverStripe 3.0 or newer
* 'Queued Jobs' module, https://github.com/nyeholt/silverstripe-queuedjobs
...
Via git:
    ...
    git clone git@github.com:gordonbanderson/silverstripe-lucene.git lucene
    cd lucene
    git checkout ss3
...
git://github.com/nyeholt/silverstripe-queuedjobs.git
...
See http://zendframework.com/manual/en/zend.search.lucene.index-creation.html#zend.search.lucene.index-creation.optimization for background info.
...
* wpSearch plugin for WordPress - http://codefury.net/projects/wpSearch/ 
* Zend_Search_Lucene documentation - http://zendframework.com/manual/en/zend.search.lucene.html
* Queued Jobs module - https://github.com/nyeholt/silverstripe-queuedjobs
* Xpdf (pdftotext PDF text extraction utility) - http://www.foolabs.com/xpdf/
